...
//    public static Reserva reserva0 = new Reserva(0, new Date(1985, 3, 25),0,0,new Date(1985, 3, 25),
//            "motivoCancelacion0", "comentario0");
//    public static Reserva reserva1 = new Reserva(1,new Date(1985, 3, 25),1,1,new Date(1985, 3, 25),
//            "motivoCancelacion1", "comentario1");
//    public static Reserva reserva2 = new Reserva(2,new Date(1985, 3, 25),2,2, new Date(1985, 3, 25),
//            "motivoCancelacion2", "comentario2");
//    public static Reserva reserva3 = new Reserva(3, new Date(1985, 3, 25),3,3, new Date(1985, 3, 25),
//            "motivoCancelacion3", "comentario3");
//    public static Reserva reserva4 = new Reserva(4,new Date(1985, 3, 25),4,4, new Date(1985, 3, 25),
//            "motivoCancelacion4", "comentario4");
//    public static Reserva reserva5 = new Reserva(5,new Date(1985, 3, 25),5,5,new Date(1985, 3, 25),
//            "motivoCancelacion5", "comentario5");
//    public static Reserva reserva6 = new Reserva(6,new Date(1985, 3, 25),6,6,new Date(1985, 3, 25),
//            "motivoCancelacion6", "comentario6");
//    public static Reserva reserva7 = new Reserva(7,new Date(1985, 3, 25),7,7, new Date(1985, 3, 25),
//            "motivoCancelacion7", "comentario7");
//    public static Reserva reserva8 = new Reserva(8,new Date(1985, 3, 25),8,8, new Date(1985, 3, 25),
//            "motivoCancelacion8", "comentario8");
//    public static Reserva reserva9 = new Reserva(9,new Date(1985, 3, 25),9,9, new Date(1985, 3, 25),
//            "motivoCancelacion9", "comentario9");
}
