...
/**
 *Aquí está toda la lógica sobre la construcción de un objeto ventana
 * que es común a todas las común a todas las ventanas.
 * 
...
public class ObjetoVentanaBuilder {
    ...
    /**
     * 
     * @param nombreFXML nombre del archivo "FXML" que se quiere abrir,
     * sin la extención ni la ruta.
    ...
    public static ObjetoVentana crear(String nombreFXML, String NombreVentana, String NombreOwner,
        ...
        if (vc == null || !vc.isActiva()) {
           ObjetoVentana obj=new ObjetoVentana(new FXMLLoader(), new VentanaCustom(NombreVentana,NombreOwner),
